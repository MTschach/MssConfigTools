...
public class ConfigToolsTest extends TestCase {
   ...
   public void testXmlConfig() {
      XmlConfigFile cfg = new XmlConfigFile(XML_FILE_NAME);
   ...
   public void testIniConfig() {
      IniConfigFile cfg = new IniConfigFile(INI_FILE_NAME);
      
      doConfigTests(cfg);
      
      //@formatter:off
      assertEquals("written config after tests", cfg.writeConfig(), "[data.contact.mobile]\n" + 
            "number=0987654321\n" + 
            "type=business\n" + 
            "\n" + 
            "[data.contact]\n" + 
   ...
   public void testPropertiesConfig() {
      PropertiesConfigFile cfg = new PropertiesConfigFile(PROPS_FILE_NAME);
   ...
   private void doConfigTests(ConfigFile cfg) {
      ...
      cfg.insertKeyValue("data.contact.email.type", "private");
      cfg.insertKeyValue("data.contact.email.number", "e.mail@gmail.com");
      cfg.insertKeyValue("data.contact.tel.number", "2345678901");
